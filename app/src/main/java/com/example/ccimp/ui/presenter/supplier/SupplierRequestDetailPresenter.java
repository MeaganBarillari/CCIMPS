...
public class SupplierRequestDetailPresenter implements SupplierRequestDetailInterface.SupplierRequestDetailPresenter {
    ...
    public SupplierRequestDetailPresenter(SupplierRequestDetailInterface.SupplierRequestDetailView supplierRequestDetailView, Request request){
        this.supplierRequestDetailView = supplierRequestDetailView;
        this.requestID = request.getRequestID();
        this.supplier = getSupplier(request.getSupplierID());
        requestItemArrayList = getCurrentRequestItems(request.getRequestID());
    }
